...
class VetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vet" do
    assert_difference("Vet.count") do
      post vets_url, params: { vet: { apellido: @vet.apellido, especialidad: @vet.especialidad, nombre: @vet.nombre } }
    end
  ...
  test "should update vet" do
    patch vet_url(@vet), params: { vet: { apellido: @vet.apellido, especialidad: @vet.especialidad, nombre: @vet.nombre } }
